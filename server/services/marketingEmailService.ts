...
export class MarketingEmailService {
  ...
  static processTemplate(template: EmailServiceTemplate, listing: Listing): EmailServiceTemplate {
    ...
    const replacements: Record<string, string> = {
      ...
      '{{property_sqft}}': (listing.squareFeet || listing.sqft)?.toString() || '',
      ...
      '{{listing_sqft}}': (listing.squareFeet || listing.sqft)?.toString() || '',
      ...
      '{listing.sqft}': (listing.squareFeet || listing.sqft)?.toString() || '',
